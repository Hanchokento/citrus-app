...
export default function TopPage() {
  ...
  const amazonUrl = buildAmazonUrl(SAMPLE_RESULT.name);
  const rakutenUrl = buildRakutenUrl(SAMPLE_RESULT.name);
  const satofuruUrl = buildSatofuruUrl(SAMPLE_RESULT.name);
        ...
        <div className="topSectionInner">
          ...
          <div className="topOutputPreview">
            ...
            <p className="topOutputPreviewNote">
              実際の結果画面では、この形式のカードが上位3品種分表示されます。
            </p>
          </div>
        </div>
      </section>
